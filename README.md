...
- Import C24 and comdirect transaction CSV exports, C24 Excel (.xlsx) exports, C24 account-statement PDFs, plus Trade Republic account-statement PDFs locally on-device (in addition to CAMT.053); bank credentials are never requested or transmitted. The statement parsers accept only recognized layouts and reject ambiguous booking rows rather than guessing.
