...
- Import C24 and comdirect transaction CSV exports, C24 Excel (.xlsx) exports, plus Trade Republic account-statement PDFs locally on-device (in addition to CAMT.053); bank credentials are never requested or transmitted. The TR parser accepts only recognized statement layouts and rejects ambiguous booking rows rather than guessing.
