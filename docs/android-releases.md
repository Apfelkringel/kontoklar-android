...
1. `versionCode` erhöhen und `versionName` setzen. Der aktuell veröffentlichte Stand ist `versionCode 56` / `versionName 0.56.0`; für die nächste Änderung beide Werte erhöhen.
