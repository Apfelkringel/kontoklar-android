...
1. `versionCode` erhöhen und `versionName` setzen. Der aktuell veröffentlichte Stand ist `versionCode 67` / `versionName 0.67.0`; für die nächste Änderung beide Werte erhöhen.
