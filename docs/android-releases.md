...
1. `versionCode` erhöhen und `versionName` setzen. Der aktuell veröffentlichte Stand ist `versionCode 77` / `versionName 0.77.0`; für die nächste Änderung beide Werte erhöhen.
