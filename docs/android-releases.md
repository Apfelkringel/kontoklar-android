...
1. `versionCode` erhöhen und `versionName` setzen. Der aktuell veröffentlichte Stand ist `versionCode 62` / `versionName 0.62.0`; für die nächste Änderung beide Werte erhöhen.
