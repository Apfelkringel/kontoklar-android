...
1. `versionCode` erhöhen und `versionName` setzen. Der aktuell veröffentlichte Stand ist `versionCode 80` / `versionName 0.80.0`; für die nächste Änderung beide Werte erhöhen.
