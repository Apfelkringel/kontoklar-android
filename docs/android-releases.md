...
1. `versionCode` erhöhen und `versionName` setzen. Der aktuell veröffentlichte Stand ist `versionCode 63` / `versionName 0.63.0`; für die nächste Änderung beide Werte erhöhen.
