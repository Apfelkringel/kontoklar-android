...
1. `versionCode` erhöhen und `versionName` setzen. Der aktuell veröffentlichte Stand ist `versionCode 73` / `versionName 0.73.0`; für die nächste Änderung beide Werte erhöhen.
