...
1. `versionCode` erhöhen und `versionName` setzen. Der aktuell veröffentlichte Stand ist `versionCode 53` / `versionName 0.53.0`; für die nächste Änderung beide Werte erhöhen.
