...
1. `versionCode` erhöhen und `versionName` setzen. Der aktuell veröffentlichte Stand ist `versionCode 51` / `versionName 0.51.0`; für die nächste Änderung beide Werte erhöhen.
