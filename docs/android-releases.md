...
1. `versionCode` erhöhen und `versionName` setzen. Der aktuell veröffentlichte Stand ist `versionCode 60` / `versionName 0.60.0`; für die nächste Änderung beide Werte erhöhen.
