...
1. `versionCode` erhöhen und `versionName` setzen. Der aktuell veröffentlichte Stand ist `versionCode 81` / `versionName 0.81.0`; für die nächste Änderung beide Werte erhöhen.
