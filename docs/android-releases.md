...
1. `versionCode` erhöhen und `versionName` setzen. Der aktuell veröffentlichte Stand ist `versionCode 85` / `versionName 0.83.2`; für die nächste Änderung beide Werte erhöhen.
