...
1. `versionCode` erhöhen und `versionName` setzen. Der aktuell veröffentlichte Stand ist `versionCode 54` / `versionName 0.54.0`; für die nächste Änderung beide Werte erhöhen.
