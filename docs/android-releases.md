...
1. `versionCode` erhöhen und `versionName` setzen. Der aktuell veröffentlichte Stand ist `versionCode 79` / `versionName 0.79.0`; für die nächste Änderung beide Werte erhöhen.
