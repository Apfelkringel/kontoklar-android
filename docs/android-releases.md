...
1. `versionCode` erhöhen und `versionName` setzen. Der aktuell veröffentlichte Stand ist `versionCode 66` / `versionName 0.66.0`; für die nächste Änderung beide Werte erhöhen.
