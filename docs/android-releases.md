...
1. `versionCode` erhöhen und `versionName` setzen. Der aktuell veröffentlichte Stand ist `versionCode 83` / `versionName 0.83.0`; für die nächste Änderung beide Werte erhöhen.
