...
1. `versionCode` erhöhen und `versionName` setzen. Der aktuell veröffentlichte Stand ist `versionCode 69` / `versionName 0.69.0`; für die nächste Änderung beide Werte erhöhen.
