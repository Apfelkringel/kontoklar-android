...
1. `versionCode` erhöhen und `versionName` setzen. Der aktuell veröffentlichte Stand ist `versionCode 65` / `versionName 0.65.0`; für die nächste Änderung beide Werte erhöhen.
