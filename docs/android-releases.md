...
1. `versionCode` erhöhen und `versionName` setzen. Der aktuell veröffentlichte Stand ist `versionCode 57` / `versionName 0.57.0`; für die nächste Änderung beide Werte erhöhen.
