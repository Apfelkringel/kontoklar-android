...
1. `versionCode` erhöhen und `versionName` setzen. Der aktuell veröffentlichte Stand ist `versionCode 59` / `versionName 0.59.0`; für die nächste Änderung beide Werte erhöhen.
