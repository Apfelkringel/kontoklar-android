...
1. `versionCode` erhöhen und `versionName` setzen. Der aktuell veröffentlichte Stand ist `versionCode 70` / `versionName 0.70.0`; für die nächste Änderung beide Werte erhöhen.
