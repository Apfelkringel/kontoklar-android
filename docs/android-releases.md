...
1. `versionCode` erhöhen und `versionName` setzen. Der aktuell veröffentlichte Stand ist `versionCode 84` / `versionName 0.83.1`; für die nächste Änderung beide Werte erhöhen.
