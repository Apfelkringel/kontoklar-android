...
1. `versionCode` erhöhen und `versionName` setzen. Der aktuell veröffentlichte Stand ist `versionCode 82` / `versionName 0.82.0`; für die nächste Änderung beide Werte erhöhen.
