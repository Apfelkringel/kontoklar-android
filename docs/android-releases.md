...
1. `versionCode` erhöhen und `versionName` setzen. Der aktuell veröffentlichte Stand ist `versionCode 78` / `versionName 0.78.0`; für die nächste Änderung beide Werte erhöhen.
