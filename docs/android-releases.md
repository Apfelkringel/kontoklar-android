...
1. `versionCode` erhöhen und `versionName` setzen. Der aktuell veröffentlichte Stand ist `versionCode 55` / `versionName 0.55.0`; für die nächste Änderung beide Werte erhöhen.
