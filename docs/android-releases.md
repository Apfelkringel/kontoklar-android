...
1. `versionCode` erhöhen und `versionName` setzen. Der aktuell veröffentlichte Stand ist `versionCode 64` / `versionName 0.64.0`; für die nächste Änderung beide Werte erhöhen.
