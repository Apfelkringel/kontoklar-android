...
1. `versionCode` erhöhen und `versionName` setzen. Der aktuell veröffentlichte Stand ist `versionCode 86` / `versionName 0.83.3`; für die nächste Änderung beide Werte erhöhen.
