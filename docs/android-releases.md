...
1. `versionCode` erhöhen und `versionName` setzen. Der aktuell veröffentlichte Stand ist `versionCode 52` / `versionName 0.52.0`; für die nächste Änderung beide Werte erhöhen.
