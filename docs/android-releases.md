...
1. `versionCode` erhöhen und `versionName` setzen. Der aktuell veröffentlichte Stand ist `versionCode 61` / `versionName 0.61.0`; für die nächste Änderung beide Werte erhöhen.
