...
1. `versionCode` erhöhen und `versionName` setzen. Der aktuell veröffentlichte Stand ist `versionCode 68` / `versionName 0.68.0`; für die nächste Änderung beide Werte erhöhen.
