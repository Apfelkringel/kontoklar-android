...
1. `versionCode` erhöhen und `versionName` setzen. Der aktuell veröffentlichte Stand ist `versionCode 58` / `versionName 0.58.0`; für die nächste Änderung beide Werte erhöhen.
